###########################################################################
## Makefile generated for component 'Serial_sendreceive'. 
## 
## Makefile     : Serial_sendreceive.mk
## Generated on : Tue Feb 15 22:32:09 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Serial_sendreceive.elf
...
PRODUCT_NAME              = Serial_sendreceive
MAKEFILE                  = Serial_sendreceive.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/ECE_Projects/Robot_Smart_Car/MATLAB_SIMULINK/Serial_Data
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Serial_sendreceive.elf
...
DEFINES_STANDARD = -DMODEL=Serial_sendreceive -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o xcp_ext_mode.o Serial_sendreceive.o Serial_sendreceive_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Serial_sendreceive_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Serial_sendreceive_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Serial_sendreceive_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Serial_sendreceive.o : $(START_DIR)/Serial_sendreceive_ert_rtw/Serial_sendreceive.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Serial_sendreceive_data.o : $(START_DIR)/Serial_sendreceive_ert_rtw/Serial_sendreceive_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Serial_sendreceive_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
