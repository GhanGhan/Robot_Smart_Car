###########################################################################
## Makefile generated for component 'OpenLoop_Motor_Control'. 
## 
## Makefile     : OpenLoop_Motor_Control.mk
## Generated on : Wed Feb 16 18:10:57 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/OpenLoop_Motor_Control.elf
...
PRODUCT_NAME              = OpenLoop_Motor_Control
MAKEFILE                  = OpenLoop_Motor_Control.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/ECE_Projects/Robot_Smart_Car/MATLAB_SIMULINK/Sim_DCMotor
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/Ghani/DOCUME~1/MATLAB/R2021b/ARDUIN~1/ARDUIN~2/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/OpenLoop_Motor_Control.elf
...
DEFINES_STANDARD = -DMODEL=OpenLoop_Motor_Control -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o xcp_ext_mode.o OpenLoop_Motor_Control.o OpenLoop_Motor_Control_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/OpenLoop_Motor_Control_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/OpenLoop_Motor_Control_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/OpenLoop_Motor_Control_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
OpenLoop_Motor_Control.o : $(START_DIR)/OpenLoop_Motor_Control_ert_rtw/OpenLoop_Motor_Control.c
	$(CC) $(CFLAGS) -o "$@" "$<"


OpenLoop_Motor_Control_data.o : $(START_DIR)/OpenLoop_Motor_Control_ert_rtw/OpenLoop_Motor_Control_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/OpenLoop_Motor_Control_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/OpenLoop_Motor_Control_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/OpenLoop_Motor_Control_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/OpenLoop_Motor_Control_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
